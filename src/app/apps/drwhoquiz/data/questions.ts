...
},
{
        ...
        slug: "intros-pop",
        copy: "Click on the play button to hear 10 seconds of a song (that can - sometimes loosely - be described as pop music) used in an episode of Doctor Who, then name the story it is from.",
...
},
{
        ...
        copy: "Click on the play button to hear 10 seconds of music composed for an episode of Doctor Who, then name the story it is from.",
        hint: "The audio will only play once.",        
        questions: [
