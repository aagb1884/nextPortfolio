interface modalProps {
  ...
  const DemoModal: React.FC<modalProps> = ({setDemoModal}) => {
    return (
        ...
        <p className={styles.sModalTxt}>You get 60 seconds per <i>guess</i>, not 60 seconds per game.</p>
        <p className={styles.sModalTxt}>Works offline.</p>
        <p className={styles.sModalTxt}>High Scores.</p>
        <p className={styles.sModalTxt}>Original music with inbuilt mute option.</p>
